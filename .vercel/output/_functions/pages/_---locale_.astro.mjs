...
import { c as createComponent, m as maybeRenderHead, r as renderComponent, a as renderTemplate, s as spreadAttributes, u as unescapeHTML, b as renderSlot, d as createAstro, e as addAttribute, f as renderHead, F as Fragment } from '../chunks/astro/server_1mv0en1U.mjs';
import 'kleur/colors';
/* empty css                                 */
import 'clsx';
...
import { $ as $$Image } from '../chunks/_astro_assets_Bf-mnZlA.mjs';
...
i18n
      ...
      .init({
        ...
        backend: {
          loadPath: "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/public/locales/{{lng}}/{{ns}}.json",
        },
        astroReactI18next: {"defaultLocale":"pt","locales":["en","pt"],"prefixDefaultLocale":false,"domains":[],"reservedRoutes":["/api"]},
...
const $$Index$2 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header class="sticky top-0 flex justify-between items-center py-4 px-8 border-b-1 border-b-slate-800 bg-slate-950"> <h1 class="text-lg font-bold text-blue-400">${t("header.title")}</h1> ${renderComponent($$result, "HeaderMenu", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/layout/header/header-menu", "client:component-export": "default" })} </header>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/layout/header/index.astro", void 0);
...
const Github = createSvgComponent({"meta":{"src":"/_astro/GitHub.BfaWu_BC.svg","width":24,"height":24,"format":"svg"},"attributes":{"width":"24","height":"24","viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","class":"lucide lucide-github h-8 w-8","aria-hidden":"true"},"children":"<path d=\"M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4\"></path><path d=\"M9 18c-4.51 2-5-2-7-2\"></path>"});

const Linkedin = createSvgComponent({"meta":{"src":"/_astro/linkedin.OCCInbJ7.svg","width":24,"height":24,"format":"svg"},"attributes":{"width":"24","height":"24","viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round","class":"lucide lucide-linkedin h-8 w-8","aria-hidden":"true"},"children":"<path d=\"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z\"></path><rect width=\"4\" height=\"12\" x=\"2\" y=\"9\"></rect><circle cx=\"4\" cy=\"4\" r=\"2\"></circle>"});

const $$SocialMedia = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<nav aria-label="redes sociais" class="flex items-center gap-2"> <a class="group flex items-center justify-center rounded-md p-2 hover:bg-slate-800" href="https://github.com/pattuzzoj"> ${renderComponent($$result, "Github", Github, { "class": "group-hover:fill-white" })} </a> <a class="group flex items-center justify-center rounded-md p-2 hover:bg-slate-800" href="https://www.linkedin.com/in/pattuzzoj"> ${renderComponent($$result, "Linkedin", Linkedin, { "class": "group-hover:fill-blue-500" })} </a> </nav>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/social-media.astro", void 0);

const $$TechLabel = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<span class="text-xs border-1 border-slate-700 bg-slate-800 rounded-full px-2 py-1"> ${renderSlot($$result, $$slots["default"])} </span>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/tech-label.astro", void 0);

const $$Astro$6 = createAstro();
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer class="flex justify-center border-t-1 border-slate-700 py-8 px-8"> <div class="w-full max-w-7xl space-y-16"> <div class="flex flex-col gap-8 lg:flex-row"> <div class="md:w-1/3"> <h3>${t("footer.title")}</h3> <p>${t("footer.description")}</p> </div> <div class="md:w-1/3 space-y-2"> <h4 id="menu">${t("footer.usefulLinks.title")}</h4> <nav aria-labelledby="menu" class="flex flex-col gap-2"> ${t("footer.usefulLinks.menu", { returnObjects: true }).map(({ label, href }, index) => renderTemplate`<a class="text-white/60 hover:text-white"${addAttribute(`#${href}`, "href")}>${label}</a>`)} </nav> </div> <div class="md:w-1/3"> <h4 id="contact">${t("footer.connect")}</h4> ${renderComponent($$result, "SocialMedia", $$SocialMedia, {})} </div> </div> <div class="flex flex-col gap-2"> <p class="text-center text-slate-300">© 2025 Júlio Pattuzzo.</p> <p class="text-center space-x-2">${renderComponent($$result, "TechLabel", $$TechLabel, {}, { "default": ($$result2) => renderTemplate`Astro` })}${renderComponent($$result, "TechLabel", $$TechLabel, {}, { "default": ($$result2) => renderTemplate`React` })}${renderComponent($$result, "TechLabel", $$TechLabel, {}, { "default": ($$result2) => renderTemplate`Tailwind` })}</p> </div> </div> </footer>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/layout/footer.astro", void 0);
    ...
    /* @__PURE__ */ jsxs(Tabs.Content, { value: "front-end", className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Astro.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Nextjs.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Solidjs.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: ReactIcon.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Tailwind.src, className: "h-8 w-8" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(Tabs.Content, { value: "back-end", className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Nestjs.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Express.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Deno.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Nodejs.src, className: "h-8 w-8" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(Tabs.Content, { value: "database", className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Drizzle.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Prisma.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Postgres.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: MongoDB.src, className: "h-8 w-8" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(Tabs.Content, { value: "tests", className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Vitest.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Jest.src, className: "h-8 w-8" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxs(Tabs.Content, { value: "tools", className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Git.src, className: "h-8 w-8" })
        }
      ),
      /* @__PURE__ */ jsx(
        CardTech,
        {
          ...
          children: /* @__PURE__ */ jsx("img", { src: Docker.src, className: "h-8 w-8" })
        }
      )
    ] })
  ] }) });
...
const icons = {"lucide":{"prefix":"lucide","icons":{"square-arrow-out-up-right":{"body":"<path fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M21 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h6m10 0l-9 9m3-9h6v6\"/>"},"monitor":{"body":"<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\"><rect width=\"20\" height=\"14\" x=\"2\" y=\"3\" rx=\"2\"/><path d=\"M8 21h8m-4-4v4\"/></g>"},"settings":{"body":"<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\"><path d=\"M9.671 4.136a2.34 2.34 0 0 1 4.659 0a2.34 2.34 0 0 0 3.319 1.915a2.34 2.34 0 0 1 2.33 4.033a2.34 2.34 0 0 0 0 3.831a2.34 2.34 0 0 1-2.33 4.033a2.34 2.34 0 0 0-3.319 1.915a2.34 2.34 0 0 1-4.659 0a2.34 2.34 0 0 0-3.32-1.915a2.34 2.34 0 0 1-2.33-4.033a2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915\"/><circle cx=\"12\" cy=\"12\" r=\"3\"/></g>"},"database":{"body":"<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\"><ellipse cx=\"12\" cy=\"5\" rx=\"9\" ry=\"3\"/><path d=\"M3 5v14a9 3 0 0 0 18 0V5\"/><path d=\"M3 12a9 3 0 0 0 18 0\"/></g>"},"flask-conical":{"body":"<path fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M14 2v6a2 2 0 0 0 .245.96l5.51 10.08A2 2 0 0 1 18 22H6a2 2 0 0 1-1.755-2.96l5.51-10.08A2 2 0 0 0 10 8V2M6.453 15h11.094M8.5 2h7\"/>"},"map-pin":{"body":"<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\"><path d=\"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0\"/><circle cx=\"12\" cy=\"10\" r=\"3\"/></g>"},"mail":{"body":"<g fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\"><path d=\"m22 7l-8.991 5.727a2 2 0 0 1-2.009 0L2 7\"/><rect width=\"20\" height=\"16\" x=\"2\" y=\"4\" rx=\"2\"/></g>"},"arrow-right":{"body":"<path fill=\"none\" stroke=\"currentColor\" stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M5 12h14m-7-7l7 7l-7 7\"/>"}},"lastModified":1757879424,"width":24,"height":24}};
...
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/node_modules/astro-icon/components/Icon.astro", void 0);
...
const $$CardProject = createComponent(($$result, $$props, $$slots) => {
  ...
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col justify-between gap-4 max-w-sm border-1 border-slate-700 rounded-md bg-slate-900 p-4"> ${renderComponent($$result, "Image", $$Image, { "class": "aspect-video object-cover object-top-left rounded-md", "width": 500, "height": 200, "src": props.banner, "alt": "" })} <div class="h-full flex flex-col justify-between space-y-4"> <h3>${props.title}</h3> <p class="text-sm text-slate-400">${props.description}</p> <div class="flex items-center flex-wrap gap-2"> ${props.techs.map((tech) => renderTemplate`${renderComponent($$result, "TechLabel", $$TechLabel, {}, { "default": ($$result2) => renderTemplate`${tech}` })}`)} </div> <div class="flex justify-between items-center gap-2"> <a class="flex justify-center items-center w-full gap-2 bg-blue-600 hover:bg-blue-700 rounded-lg p-2"${addAttribute(props.live, "href")} target="_blank"> ${renderComponent($$result, "Icon", $$Icon, { "name": "lucide:square-arrow-out-up-right", "class": "h-4" })} ${t("home:projects.cta")} </a> <a class="group flex items-center h-full border-1 border-slate-700 rounded-lg p-2 bg-slate-800 hover:bg-slate-700"${addAttribute(props.github, "href")} target="_blank"> ${renderComponent($$result, "Github", Github, { "class": "w-6 h-6 group-hover:fill-white" })} </a> </div> </div> </div>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/card/card-project.astro", void 0);

const Utilify = new Proxy({"src":"/_astro/utilify-banner.mZu-7DQe.png","width":1243,"height":913,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/assets/images/projects/utilify-banner.png";
							}
...
const NexonUtilis = new Proxy({"src":"/_astro/nexonutilis-banner.CHlzHvmC.png","width":1236,"height":983,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/assets/images/projects/nexonutilis-banner.png";
							}
...
const Futuresphere = new Proxy({"src":"/_astro/futuresphere-banner.BmB3Kq7i.png","width":973,"height":737,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/assets/images/projects/futuresphere-banner.png";
							}
...
const $$Projects = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="w-fit grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-self-center items-stretch gap-6"> ${renderComponent($$result, "CardProject", $$CardProject, { "banner": Utilify, "title": t("home:projects.items.utilify.title"), "description": t("home:projects.items.utilify.description"), "techs": t("home:projects.items.utilify.technologies", { returnObjects: true }), "live": "https://utilify.js.org/", "github": "https://github.com/pattuzzoj/utilify" })} ${renderComponent($$result, "CardProject", $$CardProject, { "banner": NexonUtilis, "title": t("home:projects.items.nexon.title"), "description": t("home:projects.items.nexon.description"), "techs": t("home:projects.items.nexon.technologies", { returnObjects: true }), "live": "https://nexonutilis.vercel.app", "github": "https://github.com/pattuzzoj/nexonutilis" })} ${renderComponent($$result, "CardProject", $$CardProject, { "banner": Futuresphere, "title": t("home:projects.items.futuresphere.title"), "description": t("home:projects.items.futuresphere.description"), "techs": t("home:projects.items.futuresphere.technologies", { returnObjects: true }), "live": "https://futuresphere.vercel.app", "github": "https://github.com/pattuzzoj/futuresphere" })} <!--
    <CardProject
      banner={Nowted}
      title="Nowted"
    ...
    />
  --> </div>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/sections/projects.astro", void 0);

const $$Astro$2 = createAstro();
const $$CardContact = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$CardContact;
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col lg:flex-row max-lg:items-center max-lg:text-center gap-4"> <div class="flex justify-center items-center aspect-square h-12 w-12 rounded-md p-2 bg-slate-800"> ${renderSlot($$result, $$slots["icon"])} </div> <div> <h5>${props.title}</h5> ${renderSlot($$result, $$slots["default"])} </div> </div>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/card/card-contact.astro", void 0);

const $$Contact = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col lg:flex-row justify-center gap-8"> <div class="w-full lg:w-1/2 lg:max-w-xl flex flex-col justify-between gap-8"> <div class="flex flex-col max-md:items-center gap-8"> <h3 class="hidden lg:block">${t("home:contact.info.title")}</h3> ${renderComponent($$result, "CardContact", $$CardContact, { "title": t("home:contact.info.location.title") }, { "default": ($$result2) => renderTemplate`  <span>${t("home:contact.info.location.value")}</span> `, "icon": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "slot": "icon", "name": "lucide:map-pin", "class": "text-blue-400" })}` })} ${renderComponent($$result, "CardContact", $$CardContact, { "title": t("home:contact.info.email.title") }, { "default": ($$result2) => renderTemplate`  <a class="text-blue-400 hover:text-blue-500"${addAttribute(`mailto:${t("home:contact.info.email.value")}`, "href")}>${t("home:contact.info.email.value")}</a> `, "icon": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon, { "slot": "icon", "name": "lucide:mail", "class": "text-blue-400" })}` })} ${renderComponent($$result, "CardContact", $$CardContact, { "title": t("home:contact.info.linkedin.title") }, { "default": ($$result2) => renderTemplate`  <a class="text-blue-400 hover:text-blue-500"${addAttribute(t("home:contact.info.linkedin.value"), "href")}>${t("home:contact.info.linkedin.value")}</a> `, "icon": ($$result2) => renderTemplate`${renderComponent($$result2, "Linkedin", Linkedin, { "slot": "icon", "class": "text-blue-400" })}` })} </div> <div class="w-full text-center rounded-md p-6 space-y-4 bg-blue-600"> <h4>${t("home:contact.info.freelance")}</h4> <p>${t("home:contact.info.cta")}</p> </div> </div> <div class="w-full lg:w-1/2 lg:max-w-xl"> ${renderComponent($$result, "ContactForm", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "@/components/form/contact-form", "client:component-export": "default" })} </div> </div>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/sections/contact.astro", void 0);
...
const $$Section = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Section;
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(props.id, "id")} class="space-y-8"> <div class="space-y-2"> <h2 class="text-center">${props.title}</h2> <h3 class="text-center text-slate-300">${props.subtitle}</h3> </div> ${renderSlot($$result, $$slots["default"])} </section>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/layout/section.astro", void 0);
...
const $$CardStack = createComponent(($$result, $$props, $$slots) => {
  ...
  const props = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col justify-center items-center gap-3 max-w-xs p-6 border-1 border-slate-700 rounded-lg bg-slate-900 text-center"> <span class="text-blue-400"> ${renderSlot($$result, $$slots["icon"])} ${renderComponent($$result, "Icon", $$Icon, { "slot": "icon", "name": props.icon, "class": "h-12 w-12" })} </span> <h4>${props.title}</h4> <p class="text-slate-400">${props.description}</p> </div>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/card/card-stack.astro", void 0);

const $$About = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="flex flex-col justify-center items-center gap-6"> ${t("home:about.paragraphs", { returnObjects: true }).map((item) => renderTemplate`<p class="text-slate-300 max-w-4xl text-center">${item}</p>`)} <div class="w-fit place-self-center grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"> ${t("home:about.cards", { returnObjects: true }).map(({ title, description, icon }) => renderTemplate`${renderComponent($$result, "CardStack", $$CardStack, { "title": title, "description": description, "icon": icon })}`)} </div> </div>`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/components/view/sections/about.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$Index$1, { "title": t("home:meta.title"), "description": t("home:meta.description"), "author": t("home:meta.author"), "keywords": t("home:meta.keywords") }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section${addAttribute(t("home:hero.id"), "id")} class="flex flex-col justify-center items-center gap-6 text-center"> <div class="space-y-4"> <h2 class="text-4xl! md:text-5xl! lg:text-6xl!"> ${t("home:hero.title")} <span class="text-blue-400">Júlio Pattuzzo</span> </h2> <p class="text-2xl! text-slate-300"> ${t("home:hero.description")} </p> </div> <div class="space-x-4"> ${t("home:hero.skills", { returnObjects: true }).map((item) => renderTemplate`${renderComponent($$result2, "TechLabel", $$TechLabel, {}, { "default": ($$result3) => renderTemplate`${item}` })}`)} </div> <nav aria-label="navegação principal" class="flex flex-col sm:flex-row items-center gap-4"> <a class="w-64 flex justify-center items-center gap-2 rounded-md py-2 px-8 bg-blue-600 hover:bg-blue-700" href="#projetos">${t("home:hero.buttons.projects")} ${renderComponent($$result2, "Icon", $$Icon, { "name": "lucide:arrow-right", "class": "h-5" })}</a> <a class="w-64 rounded-md py-2 px-8 bg-slate-800 hover:bg-slate-700 border-1 border-slate-700" href="/curriculo.pdf" download>${t("home:hero.buttons.cv")}</a> </nav> ${renderComponent($$result2, "SocialMedia", $$SocialMedia, {})} </section> ${renderComponent($$result2, "Section", $$Section, { "id": t("home:about.id"), "title": t("home:about.title"), "subtitle": t("home:about.subtitle") }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "AboutSection", $$About, {})} ` })} ${renderComponent($$result2, "Section", $$Section, { "id": t("home:technologies.id"), "title": t("home:technologies.title"), "subtitle": t("home:technologies.subtitle") }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "TechsMenu", TechsMenu, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/view/sections/techs-menu", "client:component-export": "default" })} ` })} ${renderComponent($$result2, "Section", $$Section, { "id": t("home:projects.id"), "title": t("home:projects.title"), "subtitle": t("home:projects.subtitle") }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Projects", $$Projects, {})} ` })} ${renderComponent($$result2, "Section", $$Section, { "id": t("home:contact.id"), "title": t("home:contact.title"), "subtitle": t("home:contact.subtitle") }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Contact", $$Contact, {})} ` })} ` })}`;
}, "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/pages/[...locale]/index.astro", void 0);

const $$file = "/run/media/reiden/9e7c9add-c823-456b-a164-c5b1810645ee/GitHub/portfolio/src/pages/[...locale]/index.astro";
const $$url = "/[...locale]";
