    ...
    <div>
      <Tabs.Root className="flex flex-col items-center gap-6" defaultValue="front-end">
        <Tabs.List className="w-fit flex justify-evenly items-center gap-4 rounded-lg p-2 bg-slate-800">
          <Tabs.Trigger className="rounded-md p-1 data-selected:bg-blue-600 hover:bg-slate-700" value="front-end">Front-End</Tabs.Trigger>
          <Tabs.Trigger className="rounded-md p-1 data-selected:bg-blue-600 hover:bg-slate-700" value="back-end">Back-End</Tabs.Trigger>
          <Tabs.Trigger className="rounded-md p-1 data-selected:bg-blue-600 hover:bg-slate-700" value="database">Database</Tabs.Trigger>
          <Tabs.Trigger className="rounded-md p-1 data-selected:bg-blue-600 hover:bg-slate-700" value="testes">Testes</Tabs.Trigger>
          <Tabs.Trigger className="rounded-md p-1 data-selected:bg-blue-600 hover:bg-slate-700" value="tools">Tools</Tabs.Trigger>
        </Tabs.List>
        <Tabs.Content value="front-end" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <CardTech icon={<Nextjs className="h-8 w-8 fill-white" />} title="Next.js" description="Framework React completo com SSR, SSG e roteamento integrado." />
        ...
        <Tabs.Content value="back-end" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <CardTech icon={<Express className="h-8 w-8 fill-white" />} title="Express" description="Framework minimalista para Node.js. Flexível, mas sem estrutura opinativa." />
        ...
        <Tabs.Content value="database" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <CardTech icon={<Drizzle className="h-8 w-8 fill-lime-400" />} title="DrizzleORM" description="ORM leve com tipagem forte e zero overhead. Ideal para controle total." />
          <CardTech icon={<Prisma className="h-8 w-8 fill-white" />} title="Prisma" description="ORM moderno com foco em produtividade. Consultas seguras e geradas automaticamente." />
        ...
        <Tabs.Content value="testes" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
