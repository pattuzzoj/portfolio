  ...
  return (
    <header className="sticky top-0 flex justify-between items-center py-4 px-8 border-b-1 border-b-slate-800 bg-slate-950">
      ...
      <div className="hidden md:flex items-center gap-8">
        <nav aria-label="navegação principal" className="space-x-4 lg:space-x-6">
        ...
        <a href="/currículo.pdf" download className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md">Download CV</a>
      </div>
