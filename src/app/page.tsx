    ...
    <>
      <section id="inicio" className="flex flex-col justify-center items-center gap-4 text-center">
        ...
        <div className="space-x-4">
          ...
          <TechLabel>Drizzle ORM</TechLabel>
        </div>
        <nav aria-label="navegação principal" className="flex flex-col sm:flex-row items-center gap-4">
          <a className="w-64 flex justify-center items-center gap-2 rounded-md py-2 px-8 bg-blue-600 hover:bg-blue-700" href="#projetos">Ver Projetos <ArrowRight className="h-5" /></a>
          <a className="w-64 rounded-md py-2 px-8 bg-slate-800 hover:bg-slate-700 border-1 border-slate-700" href="/curriculo.pdf" download>Download Currículo</a>
        </nav>
        <SocialMedia />
      </section>
