...
export default function LanguagePicker() {
  ...
  return (
    <Menu.Root onSelect={(details) => setLanguage(details.value)}>
      <Menu.Trigger className="w-full flex justify-center md:w-auto p-2 rounded-md bg-fill-surface-soft hover:bg-fill-surface-hover border border-outline">
      ...
      <Menu.Positioner className=" md:w-fit">
        <Menu.Content className="flex flex-col p-1 border rounded-md border-outline bg-fill-surface-soft">
