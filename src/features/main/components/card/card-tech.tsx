...
export default function CardTech(props: CardTechProps) {
  return (
    <a className="w-full flex justify-between items-center gap-4 max-w-md border-1 border-slate-700 rounded-md p-4 bg-slate-900 hover:bg-slate-700" href={props.href} target="_blank">
