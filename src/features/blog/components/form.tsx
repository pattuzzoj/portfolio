...
export default function Form() {
  ...
  return (
    <form ref={menuRef} action="" className="group relative min-w-md" onFocus={() => setIsFocused(true)}>
      ...
      <div data-form-open={isFocused} className="w-full hidden data-[form-open=true]:flex flex-col gap-2 absolute top-full left-0 z-10 rounded-t-none rounded-b-xl bg-slate-900">
